...
//#endregion
	...
	{	
		...
		/// VEREADORES - LEGISLATURAS ///		
			jQuery("select[name=fil_legislatura]").change(function()
			{
				
				jQuery.post("mod_includes_portal/php/carrega-vereadores-legislatura.php",
				{
		...
		/// MESA DIRETORA - PROCURA SESSÃO ///		
			jQuery("select[name=fil_mesa_legislatura]").change(function()
			{			
			
				jQuery("select[name=fil_sessao]").html('<option value="">Carregando...</option>');
				jQuery.post("mod_includes_portal/php/procura_sessao.php",
				{
					legislatura:jQuery(this).val()					
				},
				function(valor) // Carrega o resultado acima para o campo catadm
				{				
					...
					jQuery("select[name=fil_sessao]").show();
					jQuery("select[name=fil_sessao]").html(valor);
				});
			});
		
		/// MESA DIRETORA - PROCURA MESA DIRETORA A PARTIR DA SESSÃO ///		
			jQuery("select[name=fil_sessao]").change(function()
			{			
			
				jQuery("div.result").html('Carregando...');
				jQuery.post("mod_includes_portal/php/carrega-vereadores-mesa-diretora.php",
				{
					sessao:jQuery(this).val()					
				},
				function(valor) // Carrega o resultado acima para o campo catadm
				{				
					jQuery("div.result").html(valor);	
		...
		/// COMISSOES - PROCURA COMISSAO A PARTIR DA SESSÃO ///		
			jQuery("select[name=fil_comissoes_periodo]").change(function()
			{			
				
				jQuery("div.result").html('Carregando...');
				jQuery.post("mod_includes_portal/php/carrega-comissoes.php",
				{
