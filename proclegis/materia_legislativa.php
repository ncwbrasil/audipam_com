...
<body>
    <header>
        ...
        ?>
        <div class='naveg'>
            <a href='./'>Início</a> <i style='font-size:22px; margin:0 3px; vertical-align:middle;' class="fas fa-caret-right"></i> <a href="materias/">Matérias Legislativas</a>
        </div>
    </header>
    <main>
        ...
        <div id='materias'>
            <div class="wrapper">
                ...
                $sql = "SELECT *, t1.nome as tipo_nome,
                        ...
                        WHERE cadastro_materias.id = :id AND cadastro_materias.ativo ";
                ...
                if ($rows > 0) {
                    ...
                    if ($result['texto_original'] != '') {
                        echo "<a href='admin/" . $result['texto_original'] . "' target='_blank'><i class='fas fa-paperclip' ></i></a>";
                    }
                    echo " &nbsp;</div>
                    ...
                    $sql = "SELECT *, cadastro_materias_anexadas.id as id_anexada                                                  
                                                ...
                                                WHERE cadastro_materias_anexadas.materia = :materia AND cadastro_materias_anexadas.ativo = :ativo
                    ...
                    if ($rows > 0) {
                        ...
                        while ($result = $stmt->fetch()) {
                            ...
                            echo "<tr class='$c1'>
                                                            ...
                                                            <td  align='center'>";
                            if ($anexo != "") {
                                echo "<a href='admin/" . $anexo . "' target='_blank'><i class='fas fa-file-alt' style='font-size:20px;'></i></a>";
                            }
                            echo "</td>
                                                        </tr>";
                        }
                ...
                echo "                    
                            <div class='acompanhar'>
                                ...
                                <form id='form' enctype='multipart/form-data' method='post' action='materia_legislativa/$materia/enviar'>
