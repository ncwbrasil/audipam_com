...
<body>
    <header>
		...
		?>
        <div class='naveg'>
            <a href='./'>Início</a> <i style='font-size:22px; margin:0 3px; vertical-align:middle;' class="fas fa-caret-right"></i> Legislaturas
        </div>
	</header>
    <main style="background: <?php echo $cor_fundo ?>">
        <div id='vereadores'>
    	    <div class="wrapper">
                <div class='bloco'>
                    <p class='title'>  Vereadores por Legislatura <i class="far fa-question-circle" title="Selecione a legislatura para mostrar os vereadores cadastrados " style="cursor:help"></i></p>
                        <select id='fil_legislatura' name='fil_legislatura' >
