...
<body>
    <header>
		...
		?>
        <div class='naveg'>
            <a href='./'>Início</a> <i style='font-size:22px; margin:0 3px; vertical-align:middle;' class="fas fa-caret-right"></i> Relatórios
        </div>
	</header>
    <main style="background: <?php echo $cor_fundo ?>">
        <div class='vereadores'>
    	    <div class="wrapper">
                <div class='bloco'>
                    <p class='title'> Em breve <i class="far fa-question-circle" title="Em Breve." style="cursor:help"></i></p>
                        <?php
