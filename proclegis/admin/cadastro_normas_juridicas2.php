    ...
    <main class="cd-main-content">
        ...
        <div class="content-wrapper">
            ...
            if ($action == "adicionar_remissoes") {
                ...
                $sql = "INSERT INTO cadastro_normas_juridicas_remissoes SET " . bindFields($dados);
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                if ($stmt->execute($dados)) {
                    log_operacao($id, $PDO_PROCLEGIS);
            ...
            if ($action == "editar_remissoes") {
                $id_remissoes   = $_POST['id_remissoes'];
                $tipo_norma   = $_POST['tipo_norma'];
                $norma_revogada   = $_POST['norma_revogada'];
                $tipo_vinculo   = $_POST['tipo_vinculo'];
                ...
                $sql = "UPDATE cadastro_normas_juridicas_remissoes SET " . bindFields($dados) . " WHERE id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $dados['id'] =  $id_remissoes;
                if ($stmt->execute($dados)) {
                    log_operacao($id_remissoes, $PDO_PROCLEGIS);
            ...
            if ($action == 'excluir_remissoes') {
                $id_sub = $_GET['id_sub'];
                $sql = "UPDATE cadastro_normas_juridicas_remissoes SET ativo = :ativo WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $stmt->bindParam(':id', $id_sub);
                $stmt->bindValue(':ativo', 0);
                if ($stmt->execute()) {
            ...
            if ($pagina == "view") {
                ...
                $autores = "SELECT * FROM aux_autoria_autores WHERE ativo = :ativo ORDER BY nome ASC";
            ...
            if ($pagina == 'add') {
                ...
                echo "
                                ...
                                <p><label>Conteúdo:</label><textarea name='conteudo' id='conteudo' height='400' placeholder='Conteúdo da lei'></textarea>                          
                            </div>	                                                                                                   
                        </div>
                        <center>
            ...
            if ($pagina == 'edit') {
                ...
                if ($rows > 0) {
                    ...
                    echo "
                                ...
                                <p><label>Conteúdo:</label><textarea name='conteudo' id='conteudo' height='400' placeholder='Conteúdo da lei'>" . $result['conteudo'] . "</textarea>                          
                            </div>                                                                                                				
                            <center>
                            <div id='erro' align='center'>&nbsp;</div>
                            <input type='submit' value='Salvar' />&nbsp;&nbsp;&nbsp;&nbsp; 
            ...
            if ($pagina == 'exib') {
                ...
                include("../mod_includes/modal/NormasRemissoesAdd.php");
                ...
                if ($rows > 0) {
                    ...
                    echo "
                        ...
                        <ul class='nav nav-tabs'>
                            ...
                            <li><a data-toggle='tab' href='#remissoes' id='remissoes-tab'>Remissões</a></li>        
                    ...
                    echo "
                            ...
                            <div id='remissoes' class='tab-pane fade in'>
                                ";
                    //AND cadastro_normas_juridicas_remissoes.ativo = :ativo 
                    $sql = "SELECT *, cadastro_normas_juridicas_remissoes.id as id_remissoes  
                                                , aux_normas_juridicas_tipos.sigla as sigla                                                                                 
                                        FROM cadastro_normas_juridicas_remissoes 
                                        LEFT JOIN aux_normas_juridicas_tipos ON aux_normas_juridicas_tipos.id = cadastro_normas_juridicas_remissoes.tipo_norma
                                        LEFT JOIN cadastro_normas_juridicas ON cadastro_normas_juridicas.id = cadastro_normas_juridicas_remissoes.norma_revogada                                        
                                        LEFT JOIN aux_normas_juridicas_tipo_vinculo ON aux_normas_juridicas_tipo_vinculo.id = cadastro_normas_juridicas_remissoes.tipo_vinculo                                        
                                        WHERE norma = :norma AND norma_revogada <> '' AND cadastro_normas_juridicas_remissoes.ativo = :ativo
                                        ORDER BY cadastro_normas_juridicas_remissoes.id DESC
                                       ";
                    $stmt = $PDO_PROCLEGIS->prepare($sql);
                    $stmt->bindParam(':fil_nome1',     $fil_nome1);
                    $stmt->bindParam(':norma',     $id);
                    ...
                    echo "
                                <div id='botoes'>
                                    <div class='g_adicionar' title='Adicionar' data-toggle='modal' data-target='#remissoesAdd'><i class='fas fa-plus'></i></div>
                                </div>";
                    if ($rows > 0) {
                        echo "
                                    <table align='center' width='100%' border='0' cellspacing='0' cellpadding='10' class='bordatabela'>
                                        <tr>
                                            <td class='titulo_tabela'>Tipo de norma</td>
                                            <td class='titulo_tabela'>Norma</td>                                            
                                            <td class='titulo_tabela'>Tipo de vínculo</td>                                            
                                            <td class='titulo_tabela' align='right'>Gerenciar</td>
                                        </tr>";
                        $c = 0;
                        while ($result = $stmt->fetch()) {
                            $id_remissoes = $result['id_remissoes'];
                            $tipo_norma = $result['tipo_norma'];
                            $sigla = $result['sigla'];
                            $nome = $result['nome'];
                            $norma_revogada = $result['norma_revogada'];
                            ...
                            echo "<tr class='$c1'>
                                                    ...
                                                    <td align=center>
                                                            <div class='g_excluir' title='Excluir' onclick=\"
                                                                abreMask('<p class=\'titulo\'>Alerta</p><p><br><br>'+
                                                                    'Essa operação não poderá ser desfeita. Deseja realmente excluir este item? <br><br>'+
                                                                    '<input value=\' Sim \' type=\'button\' class=\'close_janela\' onclick=verificaPermissao(" . $permissoes["excluir"] . ",\'" . $pagina_link . "/exib/$id/excluir_remissoes/$id_remissoes#remissoes\');>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
                                                                    '<input value=\' Não \' type=\'button\' class=\'close_janela\'>');
                                                                \">	<i class='far fa-trash-alt'></i>
                                                            </div>
                                                            <div class='g_editar' title='Editar' data-toggle='modal' data-target='#remissoesEdit" . $id_remissoes . "'><i class='fas fa-pencil-alt'></i></div>                                                                                                                        
                                                    </td>
                                                </tr>";
                            include("../mod_includes/modal/NormasRemissoesEdit.php");
                        }
