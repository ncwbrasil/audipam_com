<?php
$pagina_link = 'protocolo_documentos';
...
<body>
	<main class="cd-main-content">    
		...
		<div class="content-wrapper">
            ...
            <?php                     
            $page = "Protocolo &raquo; <a href='protocolo_documentos/view'>Documentos Administrativos</a>";
            ...
            if($action == "adicionar")
            {                                   
                $sql = "INSERT INTO protocolo_documentos SET ".bindFields($dados);
                    ...
                    foreach($_FILES as $key => $files)
                    {
                        ...
                        if(!empty($files_test))
                        {
                            ...
                            if(!empty($files["name"]["texto_original"]))
                            {
                                ...
                                $sql = "UPDATE protocolo_documentos SET 
            ...
            if($action == 'editar')
            {
                ...
                $sql = "UPDATE protocolo_documentos SET ".bindFields($dados)." WHERE id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql); 
                $dados['id'] =  $id;
                if($stmt->execute($dados))
                {
            ...
            if($action == 'excluir')
            {
                $sql = "SELECT texto_original FROM protocolo_documentos WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $stmt->bindParam(':id',$id);
                if($stmt->execute())
                {
                ...
                $sql = "DELETE FROM protocolo_documentos WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $stmt->bindParam(':id',$id);
                if($stmt->execute())
                {
            ...
            if($action == 'ativar')
            {
                $sql = "UPDATE protocolo_documentos SET status = :status WHERE id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
            ...
            {        
                ...
                $sql = "INSERT INTO protocolo_documentos_anexados SET ".bindFields($dados);
                $stmt = $PDO_PROCLEGIS->prepare($sql);	
                if($stmt->execute($dados))
                {		
                    ?>
            ...
            {                       
                ...
                $sql = "UPDATE protocolo_documentos_anexados SET ".bindFields($dados)." WHERE id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql); 
                $dados['id'] =  $id_anexado;
                if($stmt->execute($dados))
                {		
            ...
            {
                $id_sub = $_GET['id_sub'];
                $sql = "DELETE FROM protocolo_documentos_anexados WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
            ...
            {            
                ...
                $sql = "INSERT INTO protocolo_documentos_doc_acessorio SET ".bindFields($dados);
                $stmt = $PDO_PROCLEGIS->prepare($sql);	
                if($stmt->execute($dados))
                {		
                    ...
                    foreach($_FILES as $key => $files)
                    {
                        ...
                        if(!empty($files_test))
                        {
                            ...
                            if(!empty($files["name"]["anexo"]))
                            {
                                ...
                                $sql = "UPDATE protocolo_documentos_doc_acessorio SET 
                                        anexo 	 = :anexo
                                        WHERE id = :id ";
                                $stmt = $PDO_PROCLEGIS->prepare($sql);
            ...
            {                       
                ...
                $sql = "UPDATE protocolo_documentos_doc_acessorio SET ".bindFields($dados)." WHERE id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql); 
            ...
            if($action == 'excluir_doc_acessorio')
            {
                ...
                $sql = "SELECT anexo FROM protocolo_documentos_doc_acessorio WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $stmt->bindParam(':id',$id_sub);
                if($stmt->execute())
                {
                ...
                $sql = "DELETE FROM protocolo_documentos_doc_acessorio WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $stmt->bindParam(':id',$id_sub);
                if($stmt->execute())
                {
            ...
            {                       
                ...
                $sql = "INSERT INTO protocolo_documentos_tramitacao SET ".bindFields($dados);
                $stmt = $PDO_PROCLEGIS->prepare($sql);	
                if($stmt->execute($dados))
                {		
                    ...
                    foreach($_FILES as $key => $files)
                    {
                        ...
                        if(!empty($files_test))
                        {
                            ...
                            if(!empty($files["name"]["anexo"]))
                            {
                                ...
                                $sql = "UPDATE protocolo_documentos_tramitacao SET 
                                        anexo 	 = :anexo
                                        WHERE id = :id ";
                                $stmt = $PDO_PROCLEGIS->prepare($sql);
                                $stmt->bindParam(':anexo',$anexo);
            ...
            {                       
                ...
                $sql = "UPDATE protocolo_documentos_tramitacao SET ".bindFields($dados)." WHERE id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql); 
            ...
            {
                $id_sub = $_GET['id_sub'];
                $sql = "DELETE FROM protocolo_documentos_tramitacao WHERE id = :id";
                $stmt = $PDO_PROCLEGIS->prepare($sql);
                $stmt->bindParam(':id',$id_sub);
                if($stmt->execute())
                {
            ...
            {
                $tipo_query = " (protocolo_documentos.tipo = :fil_tipo) ";
            }
            ...
            {
                $classificacao_query = " (protocolo_documentos.classificacao = :fil_classificacao) ";
            }
            ...
            {
                $numero_query = " (protocolo_documentos.numero = :fil_numero) ";
            }
            ...
            {
                $ano_query = " (protocolo_documentos.ano = :fil_ano) ";
            }
            
            // $sql = "SELECT *, aux_administrativo_tipo_documento.nome as tipo_nome,
            //                   aux_administrativo_tipo_documento.sigla as tipo_sigla,
            //                   protocolo_documentos.id as id
            //          FROM protocolo_documentos 
            //         LEFT JOIN aux_administrativo_tipo_documento ON aux_administrativo_tipo_documento.id = protocolo_documentos.tipo  
            //         LEFT JOIN cadastro_usuarios ON cadastro_usuarios.usu_id = protocolo_documentos.cadastrado_por  
            ...
            //         GROUP BY protocolo_documentos.id			
            //         ORDER BY protocolo_documentos.id DESC
            ...
            if($pagina == "view")
            {
                ...
                <div id='botoes'>
                    ...
                    <div class='filtro'>
                        <form name='form_filtro' id='form_filtro' enctype='multipart/form-data' method='post' action='protocolo_documentos/view'>
                ...
                if ($rows > 0)
                {
                    ...
                    <table align='center' width='100%' border='0' cellspacing='0' cellpadding='10' class='bordatabela'>
                        ...
                        while($result = $stmt->fetch())
                        {
                            ...
                            // TRAMITACAO
                            $sql = "SELECT *, protocolo_documentos_tramitacao.id as id_tramitacao
                                            , aux_administrativo_status_tramitacao.nome as nome_status                                                   
                                            , cadastro_usuarios.usu_nome as nome_responsavel                                               
                                    FROM protocolo_documentos_tramitacao 
                                    LEFT JOIN aux_materias_unidade_tramitacao t1 ON t1.id = protocolo_documentos_tramitacao.unidade_origem
                                    LEFT JOIN aux_materias_unidade_tramitacao t2 ON t2.id = protocolo_documentos_tramitacao.unidade_destino                                        
                                    LEFT JOIN aux_administrativo_status_tramitacao ON aux_administrativo_status_tramitacao.id = protocolo_documentos_tramitacao.status_tramitacao  
                                    LEFT JOIN cadastro_usuarios ON cadastro_usuarios.usu_id = protocolo_documentos_tramitacao.responsavel                                                                                          
                                    WHERE documento = :documento
                                    ORDER BY protocolo_documentos_tramitacao.data_tramitacao ASC
                                    ";
                            ...
                            $sql = "SELECT *, protocolo_gerais.id as id_protocolo                                              
                                    ...
                                    LEFT JOIN ( protocolo_documentos 
                                        LEFT JOIN protocolo_documentos ON protocolo_documentos.id = protocolo_documentos.documento) 
                                    ON protocolo_documentos.protocolo = protocolo_gerais.id  
                                    LEFT JOIN cadastro_usuarios ON cadastro_usuarios.usu_id = protocolo_gerais.cadastrado_por                                                                                          
                                    WHERE protocolo_documentos.documento = :documento
                            ...
                            {
                                $protocolo = "<a href='protocolo_gerais/adicionar' class='red'>Documento ainda não protocolado.</a>";
                            }
                        ...
                        echo "</table>";
                        $cnt = "SELECT COUNT(*) FROM protocolo_documentos                                      
                                LEFT JOIN aux_administrativo_tipo_documento ON aux_administrativo_tipo_documento.id = protocolo_documentos.tipo  
                                LEFT JOIN cadastro_usuarios ON cadastro_usuarios.usu_id = protocolo_documentos.cadastrado_por  
            ...
            if($pagina == 'add')
            {
                ...
                $sql = "SELECT *, aux_administrativo_tipo_documento.nome as nome_tipo
                        ...
                        WHERE docadm_documentos.id = :id AND docadm_documentos.ativo = :ativo
                    ";
                    ...
                    <ul class='nav nav-tabs'>
                        ...
                        <div class='tab-content'>
                            ...
                            OBS: o número/ano do protocolo será gerado automaticamente.
                                <p><label>Natureza *:</label> <select name='natureza' id='natureza' ";if($natureza){ echo " readonly ";} echo "class='obg'>
            ...
            {            		
                $sql = "SELECT *, t1.nome as tipo_nome,
                                  ...
                                  protocolo_documentos.id as id
                        FROM protocolo_documentos 
                        LEFT JOIN aux_administrativo_tipo_documento t1 ON t1.id = protocolo_documentos.tipo                                                             
                        LEFT JOIN aux_administrativo_classificacao t2 ON t2.id = protocolo_documentos.classificacao                                                             
                        WHERE protocolo_documentos.id = :id ";
                $stmt = $PDO_PROCLEGIS->prepare($sql);            
                $stmt->bindParam(':id', $id);
                $stmt->execute();
                $rows = $stmt->rowCount();
                if($rows > 0)
                {
                    $result = $stmt->fetch();                                                                                                                 
                    echo "
                    <form name='form' id='form' enctype='multipart/form-data' method='post' action='protocolo_documentos/view/editar/$id'>
                        ...
                        <div class='tab-content'>
                            ...
                            <input type='button' id='botao_cancelar' onclick=javascript:window.location.href='protocolo_documentos/view'; value='Cancelar'/></center>
                            </center>
                        </div>
                    </form>
                    ";
                    ...
                    echo "
                        ...
                        <div class='tab-content'>
                            ...
                            <div id='anexada' class='tab-pane fade in'>
                                ";
                                $sql = "SELECT *, protocolo_documentos_anexados.id as id_anexado                                                  
                                        FROM protocolo_documentos_anexados 
                                        LEFT JOIN aux_administrativo_tipo_documento ON aux_administrativo_tipo_documento.id = protocolo_documentos_anexados.tipo_documento
                                        LEFT JOIN protocolo_documentos ON protocolo_documentos.id = protocolo_documentos_anexados.documento_anexado                                        
                                        WHERE documento = :documento
                                        ORDER BY protocolo_documentos_anexados.id DESC
                                       ";
                                $stmt = $PDO_PROCLEGIS->prepare($sql);                                    
                                ...
                                if ($rows > 0)
                                {
                                    ...
                                    <table align='center' width='100%' border='0' cellspacing='0' cellpadding='10' class='bordatabela'>
                                        ...
                                        while($result = $stmt->fetch())
                                        {
                                            ...
                                            echo "<tr class='$c1'>
                                                    <td>$sigla - $nome</td>                                                    
                                                    <td><a href='protocolo_documentos/exib/".$id_anexado."' target='_blank'>Nº $numero de $ano</a></td>
                                                    <td>$data_anexacao</td>
                            ...
                            <div id='doc_acessorio' class='tab-pane fade in'>
                                ";
                                $sql = "SELECT *, protocolo_documentos_doc_acessorio.id as id_doc_acessorio
                                                , protocolo_documentos_doc_acessorio.nome as nome
                                                , aux_administrativo_tipo_documento.nome as nome_tipo                                                  
                                        FROM protocolo_documentos_doc_acessorio 
                                        LEFT JOIN aux_administrativo_tipo_documento ON aux_administrativo_tipo_documento.id = protocolo_documentos_doc_acessorio.tipo_documento
                                        WHERE documento = :documento
                                        ORDER BY protocolo_documentos_doc_acessorio.id DESC
                                       ";
                                $stmt = $PDO_PROCLEGIS->prepare($sql);                                    
                                $stmt->bindParam(':documento', 	$id);                                    
                                $stmt->execute();
                            ...
                            <br>               				
                            <center>                                                        
                                <input type='button' id='botao_cancelar' onclick=javascript:window.location.href='protocolo_documentos/view'; value='Voltar'/></center>
                            </center>
                        </div>
                    ";
                }
