...
<body>
	<main class="cd-main-content">    
		...
		<div class="content-wrapper">
            ...
            {
                echo "
                <form name='form' id='form' enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias/exib/$id/editar_od_presenca/#ordem_dia'>                            
                    <div class='titulo'> $page   &raquo; Ordem do Dia: Presença</div>                
                    <div class='conteudo'>
