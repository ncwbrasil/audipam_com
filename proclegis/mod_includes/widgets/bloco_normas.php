...
$sql = "SELECT count(id) AS valor FROM cadastro_normas_juridicas      
";
...
<div class='quad-int'><i class="nc-icon nc-vector"></i>
    <i class="far fa-file-alt gray"></i> 
    <div class='txt'>
        Normas Jurídicas <br>
    ...
    <div class='more'>
        <a href='cadastro_normas_juridicas/view'><i class="fas fa-cog"></i> Gerenciar</a>
    </div>
</div>