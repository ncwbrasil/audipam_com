...
$sql = "SELECT count(id) AS valor FROM cadastro_proposicoes      
";
...
<div class='quad-int'><i class="nc-icon nc-vector"></i>
    <i class="fas fa-book-open purple"></i> 
    <div class='txt'>
        Proposições <br>
    ...
    <div class='more'>
        <a href='cadastro_proposicoes/view'><i class="fas fa-cog"></i> Gerenciar</a>
    </div>
</div>