...
$sql = "SELECT count(id) AS valor FROM cadastro_mesa_diretora         
";
...
<div class='quad-int'><i class="nc-icon nc-vector"></i>
    ...
    <div class='more'>
        <a href='cadastro_mesa_diretora/view'><i class="fas fa-cog"></i> Gerenciar</a>
    </div>
</div>