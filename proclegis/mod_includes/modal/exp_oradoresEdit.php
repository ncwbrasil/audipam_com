<div  class="modal fade in" id="exp_oradoresEdit<?php echo $id_exp_oradores;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">                
                <?php
                echo "	
                <form name='form_exp_oradores'  enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_exp_oradores/$id/view/editar_exp_oradores/$id_exp_oradores'>							
                    <input type='hidden' name='id_exp_oradores' id='id_exp_oradores' value='".$id_exp_oradores."'  class='obg'>
                    <p><label>Parlamentar*:</label> <select name='parlamentar' id='parlamentar' class='obg' >
                            <option value='$parlamentar'>$nome</option>";
                                $sql = "SELECT *, cadastro_parlamentares.id as id
                                        ...
                                        AND   status = :status	AND cadastro_parlamentares.ativo = :ativo
                                        ORDER BY nome ASC ";
