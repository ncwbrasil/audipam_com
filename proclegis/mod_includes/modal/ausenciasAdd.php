<div  class="modal fade in" id="ausenciasAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">
                <?php
                echo "
                <form name='form_ausencias' id='form_ausencias' enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_ab_ausencias/$id/view/adicionar_ausencias'>							
                    ...
                    <p><label>Hora*:</label> <input name='horario'  placeholder='Hora'  class='obg' autocomplete='off' onkeypress='return mascaraHorario(this,event);' maxlength='5'>
                    <p><label>Tipo de justificativa*:</label> <select name='tipo_justificativa' id='tipo_justificativa' class='obg' >
                            <option value=''>Tipo de justificativa</option>";
                                $sql = "SELECT *
