    ...
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">                
                <?php
                echo "	
                <form name='form_doc_acessorio'  enctype='multipart/form-data' method='post' action='cadastro_materias/exib/".$id."/editar_doc_acessorio#doc_acessorio'>							
                    ...
                    <p><label>Tipo de Documento*:</label> <select name='tipo_documento' id='tipo_documento' class='obg' >
                            <option value='$tipo_documento'>$descricao</option>";
                                $sql = "SELECT *
                    ...
                    <p><label>Nome*:</label> <input name='nome' placeholder='Nome' id='nome' value='$nome' class='obg'>                        
