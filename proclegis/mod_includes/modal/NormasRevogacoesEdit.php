<div  class="modal fade in" id="revogacoesEdit<?php echo $id_revogacoes;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">                
                <?php
                echo "	
                <form name='form_revogacoes'  enctype='multipart/form-data' method='post' action='cadastro_normas_juridicas/exib/".$id."/editar_revogacoes#revogacoes'>							
                    <input type='hidden' name='id_revogacoes' id='id_revogacoes' value='".$id_revogacoes."'  class='obg'>
                    ...
                    <p><label>Norma Jurídica*:</label> <select name='norma_revogada' id='norma_revogada'  class='obg' >
                        <option value='$norma_revogada'>$numero de $ano</option>                           
                    </select>
                    <p><label>Tipo de Vínculo*:</label> <select name='tipo_vinculo' id='tipo_vinculo' class='obg' >
                        <option value='$tipo_vinculo'>$descricao_ativa</option>";
                            $sql = "SELECT *
