    ...
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">
                <?php
                echo "
                <form name='form_doc_acessorio' id='form_doc_acessorio' enctype='multipart/form-data' method='post' action='docadm_documentos/exib/".$id."/adicionar_doc_acessorio#doc_acessorio'>							
                    ...
                    <p><label>Nome Documento*:</label> <input name='nome' id='nome' placeholder='Nome Documento' class='obg' > 
