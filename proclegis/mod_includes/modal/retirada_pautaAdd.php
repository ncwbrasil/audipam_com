<div  class="modal fade in" id="retirada_pautaAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">
                <?php
                echo "
                <form name='form_retirada_pauta' id='form_retirada_pauta' enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_ab_retirada_pauta/$id/view/adicionar_retirada_pauta'>							
                    ...
                    <p><label>Tipo de retirada*:</label> <select name='tipo_retirada' id='tipo_retirada' class='obg' >
                            <option value=''>Tipo de retirada</option>";
                                $sql = "SELECT *
                    ...
                    <p><label>Matéria Ordem do Dia:</label> <select name='materia_ordem_dia' id='materia_ordem_dia' >
                            <option value=''>Matéria Ordem do Dia</option>";
                                $sql = "SELECT *
                    ...
                    <p><label>Matéria do Expediente:</label> <select name='materia_expediente' id='materia_expediente' >
                            <option value=''>Matéria do Expediente</option>";
                                $sql = "SELECT *
