<div  class="modal fade in" id="exp_materiasEdit<?php echo $id_exp_materias;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">                
                <?php
                echo "	
                <form name='form_exp_materias'  enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_exp_materias/".$id."/view/editar_exp_materias'>							
                    ...
                    <p><label>Tipo de votação*:</label> <select name='tipo_votacao' id='tipo_votacao' class='obg' "; if($status != "Matéria não lida" && $status != "Matéria não votada") { echo "disabled"; }echo "> 
