    ...
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">
                <?php
                echo "
                <form name='form_tramitacao' id='form_tramitacao' enctype='multipart/form-data' method='post' action='cadastro_materias/exib/".$id."/adicionar_tramitacao/#tramitacao'>							
                    ";
                    if($unidade_destino != "")
                    {
                    ...
                    <p><label>Nome do documento:</label> <input name='nome_documento' placeholder='Nome do documento' autocomplete='off' '>                    
                    <p><label>Página(s):</label> <input name='paginas' placeholder='Exemplo: 5 - 9 ou 5, 6, 7, 8, 9' autocomplete='off' '>
