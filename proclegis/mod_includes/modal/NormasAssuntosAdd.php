    ...
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">
                <?php
                echo "
                <form name='form_assuntos' id='form_assuntos' enctype='multipart/form-data' method='post' action='cadastro_normas_juridicas/exib/".$id."/adicionar_assuntos#assuntos'>							
                    <p><label>Assunto*:</label> <select name='assunto' id='assunto' class='obg' >
                            <option value=''>Assunto</option>";
                                $sql = "SELECT *
                                        FROM aux_normas_juridicas_assuntos
                                        WHERE ativo = :ativo
