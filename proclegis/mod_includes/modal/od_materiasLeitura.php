<div  class="modal fade in" id="od_materiasLeitura<?php echo $id_od_materias;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:left; line-height:30px;">                
                <?php
                echo "	
                <form name='form_od_materias'  enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_od_materias/".$id."/view/registrar_leitura'>							
            ...
            <div class="modal-footer justify-content-center">            
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="float:left;" onclick="cancelarLeituraOd(this, <?php echo $id;?>, <?php echo $id_od_materias;?>);">Cancelar Leitura</button>  
