<div  class="modal fade in" id="od_materiasVotacao<?php echo $id_od_materias;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:left; line-height:30px;">                
                <?php
                echo "	
                <form name='form_od_materias'  enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_od_materias/".$id."/view/registrar_votacao'>							
