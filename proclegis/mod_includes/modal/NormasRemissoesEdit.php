<div  class="modal fade in" id="remissoesEdit<?php echo $id_remissoes;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">                
                <?php
                echo "	
                <form name='form_remissoes'  enctype='multipart/form-data' method='post' action='cadastro_normas_juridicas/exib/".$id."/editar_remissoes#remissoes'>							
                    <input type='hidden' name='id_remissoes' id='id_remissoes' value='".$id_remissoes."'  class='obg'>
