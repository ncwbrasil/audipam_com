<div  class="modal fade in" id="oradores_explicacoesAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"  style="padding-left:0; padding-right:0; text-align:center;">
                <?php
                echo "
                <form name='form_oradores_explicacoes' id='form_oradores_explicacoes' enctype='multipart/form-data' method='post' action='cadastro_sessoes_plenarias_oradores_explicacoes/$id/view/adicionar_oradores_explicacoes'>							
