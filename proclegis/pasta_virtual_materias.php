	...
	<main class="cd-main-content" >    
		...
		<div class="content-wrapper">
            ...
            $sql = "SELECT aux_materias_tipos.nome as tipo_nome,
                            aux_materias_tipos.id as tipo_id,
                            cadastro_materias.numero as numero,
                            cadastro_materias.ano as ano
            ...
            echo "
            <div class='titulo'> <br> $tipo_nome ".$numero."/".$ano."  &raquo; Pasta Virtual</div>
            ";
                ...
                <div id="jstree" style='padding:10px; background: #FFF; height:100%;' >
                    ...
                    if($rows > 0)
                    {
                        ...
                        $sql = "SELECT *, cadastro_materias_tramitacao.id as id_tramitacao
                                ...
                                WHERE materia = :materia AND cadastro_materias_tramitacao.anexo IS NOT NULL
                        ...
                        if($rows_tra > 0)
                        {
                            ...
                            {
                                echo "                            
                                <li>".$result_tra['nome_documento']." - pág. ".$result_tra['paginas']."
                                <ul>
                                    <li data-jstree='{\"icon\":\"far fa-file-pdf\"}'>
                                    <a href='".str_replace("../","",$result_tra['anexo'])."' target='_blank'>".$result_tra['nome_anexo']."</a>
                                    </li>
                                </ul>
                                </li>                            
                                ";
            ...
            <div  style='float:right; width:71%; height:100%; border: 10px solid #323639; padding:0; background: #FFF;'>  
