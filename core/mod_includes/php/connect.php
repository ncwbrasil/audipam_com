...
// define( 'MYSQL_DB_NAME_TRANSPARENCIA', 'audipamc_transparencia');
if($_SESSION['cliente_url'])
{
...
try
{
    ...
    // $PDO_TRANSPARENCIA 	= new PDO( 'mysql:host=' . MYSQL_HOST . ';port=' . MYSQL_PORT . ';dbname=' . MYSQL_DB_NAME_TRANSPARENCIA, MYSQL_USER, MYSQL_PASSWORD );
    if($_SESSION['cliente_url'])
    {
...
// $PDO_TRANSPARENCIA->setAttribute( PDO::ATTR_EMULATE_PREPARES, false );
if($_SESSION['cliente_url'])
{
