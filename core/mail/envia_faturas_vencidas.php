...
require_once("../core/mod_includes/php/phpmailer/class.phpmailer.php");
...
$mail->FromName = "Sweet Pics"; // Seu nome
...
// $mail->AddCC('gustavo@mogicomp.com.br');
// $mail->AddCC('marcelo@mogicomp.com.br');
// $mail->AddCC('vinicius@mogicomp.com.br');
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->Subject  = "Nova(s) Fatura(s) Vencida(s)"; // Assunto da mensagem
				...
				<body class='fundo'>
					...
					<tr>
						<td align='left'>
							...
							".$datap."<br>	
							As seguintes faturas foram <u>vencidas</u>:<br><br>
							...
							<tr>
								...
								<td class='red'><b>".$datas_venc."</b></td>
								<td><b>".$valores."</b></td>
							</tr>
							</table>
							<br>
